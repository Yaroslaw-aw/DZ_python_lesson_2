# Задачи, которые были на семинаре, потом домашние задачи.

# Задача 1. Вывести таблицу истиности !х or y.
...
# Задача 2. Найти количество вхождений одной строки в другую.
...
# Задача 3. Вывести последовательность числа -3 в степенях от 0 до заданной.
...
# Задача 4. Вывести числа и их количество, на промежутке от 1 до 10_001, у которых
# число делителей равно 10.
